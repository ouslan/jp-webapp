...
class IP_520s(forms.Form):
    ...
    business_type = forms.ChoiceField(
        label = "5. Clase de negocio / Type of business:",
        choices = [('Corredor', 'Broker'), ('Agente no general', 
                'Non-general agent'), ('Agente general', 'General agent'), 
                   ('Compañía local', 'Local company')]
    )
    other_business_type = forms.CharField(label='6. Otros negocios / Other businesses:', max_length=200)
    risk_type = forms.ChoiceField(label='risk type', choices=[('Vida', 'Life'), ('Otro', 'Other')])
    ...
    incomes_premium_earned_1 = forms.CharField(label='incomes premium earned 1', max_length=100)
    incomes_premium_earned_2 = forms.CharField(label='incomes premium earned 2', max_length=100)
    ...
    incomes_commissions_1 = forms.CharField(label='incomes commissions 1', max_length=100)
    incomes_commissions_2 = forms.CharField(label='incomes commissions 2', max_length=100)
    ...
    incomes_capital_gain_loss_1 = forms.CharField(label='incomes capital gain loss 1', max_length=100)
    incomes_capital_gain_loss_2 = forms.CharField(label='incomes capital gain loss 2', max_length=100)
    incomes_other_operation_1 = forms.CharField(label='incomes other operation 1', max_length=100)
    incomes_other_operation_2 = forms.CharField(label='incomes other operation 2', max_length=100)
    ...
    expenses_premium_earned_1 = forms.CharField(label='expenses premium earned 1', max_length=100)
    expenses_premium_earned_2 = forms.CharField(label='expenses premium earned 2', max_length=100)
    expenses_disability_1 = forms.CharField(label='expenses disability 1', max_length=100)
    expenses_disability_2 = forms.CharField(label='expenses disability 2', max_length=100)
    ...
    expenses_increase_reserves_1 = forms.CharField(label='expenses increase reserves 1', max_length=100)
    expenses_increase_reserves_2 = forms.CharField(label='expenses increase reserves 2', max_length=100)
    expenses_salaries_wages_bonus_1 = forms.CharField(label='expenses salaries wages bonus 1', max_length=100)
    expenses_salaries_wages_bonus_2 = forms.CharField(label='expenses salaries wages bonus 2', max_length=100)
    expenses_commissions_1 = forms.CharField(label='expenses commissions 1', max_length=100)
    expenses_commissions_2 = forms.CharField(label='expenses commissions 2', max_length=100)
    expenses_to_employees_1 = forms.CharField(label='expenses to employees 1', max_length=100)
    expenses_to_employees_2 = forms.CharField(label='expenses to employees 2', max_length=100)
    expenses_independent_agents_1 = forms.CharField(label='expenses independent agents 1', max_length=100)
    expenses_independent_agents_2 = forms.CharField(label='expenses independent agents 2', max_length=100)
    ...
    expenses_depreciation_1 = forms.CharField(label='expenses depreciation 1', max_length=100)
    expenses_depreciation_2 = forms.CharField(label='expenses depreciation 2', max_length=100)
    expenses_dividend_policy_holder_1 = forms.CharField(label='expenses dividend policy holder 1', max_length=100)
    expenses_dividend_policy_holder_2 = forms.CharField(label='expenses dividend policy holder 2', max_length=100)
    ...
    expenses_other_purchases_1 = forms.CharField(label='expenses other purchases 1', max_length=100)
    expenses_other_purchases_2 = forms.CharField(label='expenses other purchases 2', max_length=100)
    ...
    expenses_other_operating_1 = forms.CharField(label='expenses other operating 1', max_length=100)
    expenses_other_operating_2 = forms.CharField(label='expenses other operating 2', max_length=100)
...
class IP_530(forms.Form):
    ...
    cfc = forms.ChoiceField(label='CEC', choices=[('Si', 'Si'), ('No', 'No')])
    business_type = forms.CharField(label='Tipo de negocio / Business type', max_length=100)
    other_business_type = forms.CharField(label='Otro tipo de negocio / Other business type', max_length=100)
    closing_date = forms.DateField(label='Fecha de cierre de sus libros / Your accounting period closing date', widget=forms.SelectDateWidget)
    start_year = forms.CharField(label='Año de inicio de operaciones / Year of start of operations', max_length=100)
    end_year = forms.CharField(label='Año de cierre de operaciones / Year of end of operations', max_length=100)
    
    incomes_from_persons_1 = forms.CharField(label='1. Ingresos de personas - Incomes from persons', max_length=100)
    incomes_from_persons_2 = forms.CharField(label='1. Ingresos de personas - Incomes from persons', max_length=100)
    incomes_industries_businesses_1 = forms.CharField(label='2. Ingresos de industrias y negocios - Incomes from industries and businesses', max_length=100)
    incomes_industries_businesses_2 = forms.CharField(label='2. Ingresos de industrias y negocios - Incomes from industries and businesses', max_length=100)
    incomes_rent_1 = forms.CharField(label='3. Ingresos por renta - Incomes from rent', max_length=100)
    incomes_rent_2 = forms.CharField(label='3. Ingresos por renta - Incomes from rent', max_length=100)
    incomes_interests_1 = forms.CharField(label='4. Ingresos por intereses - Incomes from interests', max_length=100)
    incomes_interests_2 = forms.CharField(label='4. Ingresos por intereses - Incomes from interests', max_length=100)
    incomes_comissions_1 = forms.CharField(label='5. Comisiones - Comissions', max_length=100)
    incomes_comissions_2 = forms.CharField(label='5. Comisiones - Comissions', max_length=100)
    incomes_gain_loss_1 = forms.CharField(label='6. Ganancia de capital - Capital gain', max_length=100)
    incomes_gain_loss_2 = forms.CharField(label='6. Ganancia de capital - Capital gain', max_length=100)
    incomes_operating_1 = forms.CharField(label='7. Otros ingresos - Other incomes', max_length=100)
    incomes_operating_2 = forms.CharField(label='7. Otros ingresos - Other incomes', max_length=100)
    expenses_salaries_wages_bonus_1 = forms.CharField(label='1. Salarios, sueldos y bonificaciones - Salaries, wages and bonuses', max_length=100)
    expenses_salaries_wages_bonus_2 = forms.CharField(label='1. Salarios, sueldos y bonificaciones - Salaries, wages and bonuses', max_length=100)
    expenses_interests_1 = forms.CharField(label='2. Gastos por intereses - Expenses by interests', max_length=100)
    expenses_interests_2 = forms.CharField(label='2. Gastos por intereses - Expenses by interests', max_length=100)
    expenses_rent_1 = forms.CharField(label='3. Gastos por rentas - Expenses by rents', max_length=100)
    expenses_rent_2 = forms.CharField(label='3. Gastos por rentas - Expenses by rents', max_length=100)
    expenses_depreciation_1 = forms.CharField(label='4. Depreciación - Depreciation', max_length=100)
    expenses_depreciation_2 = forms.CharField(label='4. Depreciación - Depreciation', max_length=100)
    expenses_donations_1 = forms.CharField(label='5. Donaciones - Donations', max_length=100)
    expenses_donations_2 = forms.CharField(label='5. Donaciones - Donations', max_length=100)
    expenses_sales_tax_1 = forms.CharField(label='6. Impuesto sobre ventas y uso - Sales and use tax', max_length=100)
    expenses_sales_tax_2 = forms.CharField(label='6. Impuesto sobre ventas y uso - Sales and use tax', max_length=100)
    expenses_machinary_equipment_1 = forms.CharField(label='7. Compra de maquinaria - Purchase of machinery', max_length=100)
    expenses_machinary_equipment_2 = forms.CharField(label='7. Compra de maquinaria - Purchase of machinery', max_length=100)
    expenses_other_purchases_1 = forms.CharField(label='8. Otras compras - Other purchases', max_length=100)
    expenses_other_purchases_2 = forms.CharField(label='8. Otras compras - Other purchases', max_length=100)
    expenses_licenses_1 = forms.CharField(label='9. Licencias - Licenses', max_length=100)
    expenses_licenses_2 = forms.CharField(label='9. Licencias - Licenses', max_length=100)
    expenses_other_operations_1 = forms.CharField(label='10. Otros gastos - Other expenses', max_length=100)
    expenses_other_operations_2 = forms.CharField(label='10. Otros gastos - Other expenses', max_length=100)
    expenses_total_1 = forms.CharField(label='11. Total de gastos (1-10) - Total expenses (1-10)', max_length=100)
    expenses_total_2 = forms.CharField(label='11. Total de gastos (1-10) - Total expenses (1-10)', max_length=100)
    gross_profit_1 = forms.CharField(label='12. Ganancia bruta (6-11) - Gross profit (6-11)', max_length=100)
    gross_profit_2 = forms.CharField(label='12. Ganancia bruta (6-11) - Gross profit (6-11)', max_length=100)
    profit_income_tax_1 = forms.CharField(label='13. Contribución sobre ingresos - Income tax', max_length=100)
    profit_income_tax_2 = forms.CharField(label='13. Contribución sobre ingresos - Income tax', max_length=100)
    profit_after_income_tax_1 = forms.CharField(label='14. Ganancia después de contribución sobre ingresos - Profit after income tax', max_length=100)
    profit_after_income_tax_2 = forms.CharField(label='14. Ganancia después de contribución sobre ingresos - Profit after income tax', max_length=100)
    sales_tax_withheld_1 = forms.CharField(label='15. Impuesto sobre ventas y uso retenido - Sales and use tax withheld', max_length=100)
    sales_tax_withheld_2 = forms.CharField(label='15. Impuesto sobre ventas y uso retenido - Sales and use tax withheld', max_length=100)
...
class IP_540(forms.Form):
    ...
    start_year = forms.CharField(label='Año de inicio de operaciones / Year of start of operations', max_length=100)
    end_year = forms.CharField(label='Año de cierre de operaciones / Year of end of operations', max_length=100)
    incomes_services_rendered_1 = forms.CharField(label='1. Ingresos por servicios prestados - Incomes from services rendered', max_length=100)
    incomes_services_rendered_2 = forms.CharField(label='1. Ingresos por servicios prestados - Incomes from services rendered', max_length=100)
    incomes_from_persons_1 = forms.CharField(label='2. Ingresos de personas - Incomes from persons', max_length=100)
    incomes_from_persons_2 = forms.CharField(label='2. Ingresos de personas - Incomes from persons', max_length=100)
    incomes_from_industries_and_businesses_1 = forms.CharField(label='3. Ingresos de industrias y negocios - Incomes from industries and businesses', max_length=100)
    incomes_from_industries_and_businesses_2 = forms.CharField(label='3. Ingresos de industrias y negocios - Incomes from industries and businesses', max_length=100)
    incomes_sale_merchandise_1 = forms.CharField(label='4. Ingresos por venta de mercancía - Incomes from sale of merchandise', max_length=100)
    incomes_sale_merchandise_2 = forms.CharField(label='4. Ingresos por venta de mercancía - Incomes from sale of merchandise', max_length=100)
    incomes_rent_machinery_and_equipment_1 = forms.CharField(label='5. Ingresos por renta de maquinaria y equipo - Incomes from rent of machinery and equipment', max_length=100)
    incomes_rent_machinery_and_equipment_2 = forms.CharField(label='5. Ingresos por renta de maquinaria y equipo - Incomes from rent of machinery and equipment', max_length=100)
    incomes_rent_land_and_building_1 = forms.CharField(label='6. Ingresos por renta de terreno y edificio - Incomes from rent of land and building', max_length=100)
    incomes_rent_land_and_building_2 = forms.CharField(label='6. Ingresos por renta de terreno y edificio - Incomes from rent of land and building', max_length=100)
    incomes_interests_1 = forms.CharField(label='7. Ingresos por intereses - Incomes from interests', max_length=100)
    incomes_interests_2 = forms.CharField(label='7. Ingresos por intereses - Incomes from interests', max_length=100)
    incomes_capital_gain_or_loss_1 = forms.CharField(label='8. Ganancia o pérdida de capital - Capital gain or loss', max_length=100)
    incomes_capital_gain_or_loss_2 = forms.CharField(label='8. Ganancia o pérdida de capital - Capital gain or loss', max_length=100)
    incomes_other_operating_income_1 = forms.CharField(label='9. Otros ingresos operacionales - Other operating income', max_length=100)
    incomes_other_operating_income_2 = forms.CharField(label='9. Otros ingresos operacionales - Other operating income', max_length=100)
    expenses_salaries_wages_bonus_1 = forms.CharField(label='1. Salarios, sueldos y bonificaciones - Salaries, wages and bonuses', max_length=100)
    expenses_salaries_wages_bonus_2 = forms.CharField(label='1. Salarios, sueldos y bonificaciones - Salaries, wages and bonuses', max_length=100)
    expenses_interests_1 = forms.CharField(label='2. Intereses - Interests', max_length=100)
    expenses_interests_2 = forms.CharField(label='2. Intereses - Interests', max_length=100)
    ...
    expenses_depreciation_1 = forms.CharField(label='4. Depreciación - Depreciation', max_length=100)
    expenses_depreciation_2 = forms.CharField(label='4. Depreciación - Depreciation', max_length=100)
    expenses_bad_debts_1 = forms.CharField(label='5. Malos créditos - Bad debts', max_length=100)
    expenses_bad_debts_2 = forms.CharField(label='5. Malos créditos - Bad debts', max_length=100)
    expenses_donations_1 = forms.CharField(label='6. Donaciones - Donations', max_length=100)
    expenses_donations_2 = forms.CharField(label='6. Donaciones - Donations', max_length=100)
    expenses_other_donations_1 = forms.CharField(label='7. Otras donaciones - Other donations', max_length=100)
    expenses_other_donations_2 = forms.CharField(label='7. Otras donaciones - Other donations', max_length=100)
    expenses_sales_taxes_1 = forms.CharField(label='8. Impuesto sobre ventas - Sales taxes', max_length=100)
    expenses_sales_taxes_2 = forms.CharField(label='8. Impuesto sobre ventas - Sales taxes', max_length=100)
    expenses_purchases_machinery_1 = forms.CharField(label='9. Compra de maquinaria - Purchase of machinery', max_length=100)
    expenses_purchases_machinery_2 = forms.CharField(label='9. Compra de maquinaria - Purchase of machinery', max_length=100)
    expenses_other_purchases_1 = forms.CharField(label='10. Otras compras - Other purchases', max_length=100)
    expenses_other_purchases_2 = forms.CharField(label='10. Otras compras - Other purchases', max_length=100)
    expenses_licenses_1 = forms.CharField(label='11. Licencias - Licenses', max_length=100)
    expenses_licenses_2 = forms.CharField(label='11. Licencias - Licenses', max_length=100)
    net_profit_1 = forms.CharField(label='12. Ganancia neta (1-11) - Net profit (1-11)', max_length=100)
    net_profit_2 = forms.CharField(label='12. Ganancia neta (1-11) - Net profit (1-11)', max_length=100)
    profit_income_tax_1 = forms.CharField(label='13. Ganancia después de contribución sobre ingresos - Profit after income tax', max_length=100)
    profit_income_tax_2 = forms.CharField(label='13. Ganancia después de contribución sobre ingresos - Profit after income tax', max_length=100)
    profit_after_income_tax_1 = forms.CharField(label='14. Ganancia después de contribución sobre ingresos - Profit after income tax', max_length=100)
    profit_after_income_tax_2 = forms.CharField(label='14. Ganancia después de contribución sobre ingresos - Profit after income tax', max_length=100)
    sales_tax_withheld_1 = forms.CharField(label='15. Impuesto sobre ventas y uso retenido - Sales tax withheld', max_length=100)
    sales_tax_withheld_2 = forms.CharField(label='15. Impuesto sobre ventas y uso retenido - Sales tax withheld', max_length=100)
    name = forms.CharField(label='Name of person filling the questionnaire', max_length=100)
    rank = forms.CharField(label='Rank', max_length=100)
...
class IP_540J(forms.Form):
    ...
    cfc = forms.ChoiceField(label='CEC', choices=[('Si', 'Si'), ('No', 'No')])
    business_type = forms.CharField(label='Tipo de negocio / Business type', max_length=100)
    business_function = forms.ChoiceField(label='Función de negocio / Business function', choices=[('Corredor', 'Broker'), ('Agente no general', 'Non-general agent'), ('Agente general', 'General agent'), ('Compañía local', 'Local company')])
    closing_date = forms.DateField(label='Fecha de cierre de sus libros / Your accounting period closing date', widget=forms.SelectDateWidget)
    start_year = forms.CharField(label='Año de inicio de operaciones / Year of start of operations', max_length=100)
    end_year = forms.CharField(label='Año de cierre de operaciones / Year of end of operations', max_length=100)
    ...
    incomes_from_persons_1 = forms.CharField(label='1. Ingresos de personas - Incomes from persons', max_length=100)
    incomes_from_persons_2 = forms.CharField(label='1. Ingresos de personas - Incomes from persons', max_length=100)
    incomes_industries_business_1 = forms.CharField(label='2. Ingresos de industrias y negocios - Incomes from industries and businesses', max_length=100)
    incomes_industries_business_2 = forms.CharField(label='2. Ingresos de industrias y negocios - Incomes from industries and businesses', max_length=100)
    expenses_newspapers_1 = forms.CharField(label='3. Gastos de periódicos - Expenses of newspapers', max_length=100)
    expenses_newspapers_2 = forms.CharField(label='3. Gastos de periódicos - Expenses of newspapers', max_length=100)
    expenses_radio_television_1 = forms.CharField(label='4. Gastos de radio y televisión - Expenses of radio and television', max_length=100)
    expenses_radio_television_2 = forms.CharField(label='4. Gastos de radio y televisión - Expenses of radio and television', max_length=100)
    expenses_other_1 = forms.CharField(label='5. Otros gastos - Other expenses', max_length=100)
    expenses_other_2 = forms.CharField(label='5. Otros gastos - Other expenses', max_length=100)
    gross_profit_1 = forms.CharField(label='6. Ganancia bruta - Gross profit', max_length=100)
    gross_profit_2 = forms.CharField(label='6. Ganancia bruta - Gross profit', max_length=100)
    dividends_paid_1 = forms.CharField(label='7. Dividendos pagados - Dividends paid', max_length=100)
    dividends_paid_2 = forms.CharField(label='7. Dividendos pagados - Dividends paid', max_length=100)
    expenses_interests_1 = forms.CharField(label='8. Gastos de intereses - Expenses of interests', max_length=100)
    expenses_interests_2 = forms.CharField(label='8. Gastos de intereses - Expenses of interests', max_length=100)
    expenses_rent_1 = forms.CharField(label='9. Gastos de renta - Expenses of rent', max_length=100)
    expenses_rent_2 = forms.CharField(label='9. Gastos de renta - Expenses of rent', max_length=100)
    expenses_gain_loss_1 = forms.CharField(label='10. Ganancia o pérdida - Gain or loss', max_length=100)
    expenses_gain_loss_2 = forms.CharField(label='10. Ganancia o pérdida - Gain or loss', max_length=100)
    dividends_paid_other_1 = forms.CharField(label='11. Dividendos pagados a otros - Dividends paid to others', max_length=100)
    dividends_paid_other_2 = forms.CharField(label='11. Dividendos pagados a otros - Dividends paid to others', max_length=100)
    incomes_total_1 = forms.CharField(label='12. Total de ingresos - Total incomes', max_length=100)
    incomes_total_2 = forms.CharField(label='12. Total de ingresos - Total incomes', max_length=100)
    expenses_total_1 = forms.CharField(label='13. Total de gastos - Total expenses', max_length=100)
    expenses_total_2 = forms.CharField(label='13. Total de gastos - Total expenses', max_length=100)
    salaries_wages_bonus_1 = forms.CharField(label='14. Salarios, sueldos y bonificaciones - Salaries, wages and bonuses', max_length=100)
    salaries_wages_bonus_2 = forms.CharField(label='14. Salarios, sueldos y bonificaciones - Salaries, wages and bonuses', max_length=100)
    ...
    depreciation_1 = forms.CharField(label='17. Depreciación - Depreciation', max_length=100)
    depreciation_2 = forms.CharField(label='17. Depreciación - Depreciation', max_length=100)
    other_taxes_1 = forms.CharField(label='18. Otros impuestos - Other taxes', max_length=100)
    other_taxes_2 = forms.CharField(label='18. Otros impuestos - Other taxes', max_length=100)
    ...
    sales_tax_1 = forms.CharField(label='20. Impuesto sobre ventas - Sales tax', max_length=100)
    sales_tax_2 = forms.CharField(label='20. Impuesto sobre ventas - Sales tax', max_length=100)
    machinery_1 = forms.CharField(label='21. Compra de maquinaria - Purchase of machinery', max_length=100)
    machinery_2 = forms.CharField(label='21. Compra de maquinaria - Purchase of machinery', max_length=100)
    other_purchases_1 = forms.CharField(label='22. Otras compras - Other purchases', max_length=100)
    other_purchases_2 = forms.CharField(label='22. Otras compras - Other purchases', max_length=100)
    ...
    other_operating_expenses_1 = forms.CharField(label='24. Otras operaciones - Other operations', max_length=100)
    other_operating_expenses_2 = forms.CharField(label='24. Otras operaciones - Other operations', max_length=100)
    profit_incomes_tax_1 = forms.CharField(label='25. Ganancia después de contribución sobre ingresos - Profit after income tax', max_length=100)
    profit_incomes_tax_2 = forms.CharField(label='25. Ganancia después de contribución sobre ingresos - Profit after income tax', max_length=100)
    profit_incomes_mortage_loans_1 = forms.CharField(label='26. Ganancia después de contribución sobre ingresos y préstamos hipotecarios - Profit after income tax and mortgage loans', max_length=100)
    profit_incomes_mortage_loans_2 = forms.CharField(label='26. Ganancia después de contribución sobre ingresos y préstamos hipotecarios - Profit after income tax and mortgage loans', max_length=100)
    sales_tax_withheld_1 = forms.CharField(label='27. Impuesto sobre ventas y uso retenido - Sales and use tax withheld', max_length=100)
    sales_tax_withheld_2 = forms.CharField(label='27. Impuesto sobre ventas y uso retenido - Sales and use tax withheld', max_length=100)
...
class IP_620(forms.Form):
    ...
    patients_service_revenue_from_persons_1 = forms.CharField(label='1. Ingresos por servicios prestados a personas - Patients service revenue from persons', max_length=100)
    patients_service_revenue_from_persons_2 = forms.CharField(label='1. Ingresos por servicios prestados a personas - Patients service revenue from persons', max_length=100)
    patients_service_revenue_from_industries_business_1 = forms.CharField(label='2. Ingresos por servicios prestados a industrias y negocios - Patients service revenue from industries and businesses', max_length=100)
    patients_service_revenue_from_industries_business_2 = forms.CharField(label='2. Ingresos por servicios prestados a industrias y negocios - Patients service revenue from industries and businesses', max_length=100)
    contractual_adjustments_1 = forms.CharField(label='3. Ajustes contractuales - Contractual adjustments', max_length=100)
    contractual_adjustments_2 = forms.CharField(label='3. Ajustes contractuales - Contractual adjustments', max_length=100)
    net_patient_service_revenue_1 = forms.CharField(label='4. Ingresos netos por servicios a pacientes - Net patient service revenue', max_length=100)
    net_patient_service_revenue_2 = forms.CharField(label='4. Ingresos netos por servicios a pacientes - Net patient service revenue', max_length=100)
    other_incomes_1 = forms.CharField(label='5. Otros ingresos - Other incomes', max_length=100)
    other_incomes_2 = forms.CharField(label='5. Otros ingresos - Other incomes', max_length=100)
    other_incomes_rent_1 = forms.CharField(label='6. Ingresos por renta - Incomes from rent', max_length=100)
    other_incomes_rent_2 = forms.CharField(label='6. Ingresos por renta - Incomes from rent', max_length=100)
    other_incomes_interest_1 = forms.CharField(label='7. Ingresos por intereses - Incomes from interests', max_length=100)
    other_incomes_interest_2 = forms.CharField(label='7. Ingresos por intereses - Incomes from interests', max_length=100)
    other_incomes_capital_gain_loss_1 = forms.CharField(label='8. Ganancia o pérdida de capital - Capital gain or loss', max_length=100)
    other_incomes_capital_gain_loss_2 = forms.CharField(label='8. Ganancia o pérdida de capital - Capital gain or loss', max_length=100)
    other_incomes_operating_1 = forms.CharField(label='9. Otros ingresos operacionales - Other operating income', max_length=100)
    other_incomes_operating_2 = forms.CharField(label='9. Otros ingresos operacionales - Other operating income', max_length=100)
    total_incomes_1 = forms.CharField(label='10. Total de ingresos - Total incomes', max_length=100)
    total_incomes_2 = forms.CharField(label='10. Total de ingresos - Total incomes', max_length=100)
    total_expenses_1 = forms.CharField(label='11. Total de gastos - Total expenses', max_length=100)
    total_expenses_2 = forms.CharField(label='11. Total de gastos - Total expenses', max_length=100)
    expenses_salaries_wages_bonus_1 = forms.CharField(label='1. Salarios, sueldos y bonificaciones - Salaries, wages and bonuses', max_length=100)
    expenses_salaries_wages_bonus_2 = forms.CharField(label='1. Salarios, sueldos y bonificaciones - Salaries, wages and bonuses', max_length=100)
    expenses_interest_1 = forms.CharField(label='2. Gastos por intereses - Expenses by interests', max_length=100)
    expenses_interest_2 = forms.CharField(label='2. Gastos por intereses - Expenses by interests', max_length=100)
    expenses_rent_1 = forms.CharField(label='3. Gastos por rentas - Expenses by rents', max_length=100)
    expenses_rent_2 = forms.CharField(label='3. Gastos por rentas - Expenses by rents', max_length=100)
    expenses_food_patients_1 = forms.CharField(label='4. Gastos de alimentos para pacientes - Expenses of food for patients', max_length=100)
    expenses_food_patients_2 = forms.CharField(label='4. Gastos de alimentos para pacientes - Expenses of food for patients', max_length=100)
    expenses_free_food_to_employees_1 = forms.CharField(label='5. Gastos de alimentos gratis a empleados - Expenses of free food to employees', max_length=100)
    expenses_free_food_to_employees_2 = forms.CharField(label='5. Gastos de alimentos gratis a empleados - Expenses of free food to employees', max_length=100)
    expenses_uniforms_1 = forms.CharField(label='6. Gastos de uniformes - Expenses of uniforms', max_length=100)
    expenses_uniforms_2 = forms.CharField(label='6. Gastos de uniformes - Expenses of uniforms', max_length=100)
    expenses_depreciation_1 = forms.CharField(label='7. Depreciación - Depreciation', max_length=100)
    expenses_depreciation_2 = forms.CharField(label='7. Depreciación - Depreciation', max_length=100)
    expenses_bad_debts_1 = forms.CharField(label='8. Malos créditos - Bad debts', max_length=100)
    expenses_bad_debts_2 = forms.CharField(label='8. Malos créditos - Bad debts', max_length=100)
    expenses_donations_1 = forms.CharField(label='9. Donaciones - Donations', max_length=100)
    expenses_donations_2 = forms.CharField(label='9. Donaciones - Donations', max_length=100)
    expenses_sales_tax_1 = forms.CharField(label='10. Impuesto sobre ventas y uso - Sales and use tax', max_length=100)
    expenses_sales_tax_2 = forms.CharField(label='10. Impuesto sobre ventas y uso - Sales and use tax', max_length=100)
    expenses_machinery_1 = forms.CharField(label='11. Compra de maquinaria - Purchase of machinery', max_length=100)
    expenses_machinery_2 = forms.CharField(label='11. Compra de maquinaria - Purchase of machinery', max_length=100)
    expenses_on_other_purchases_1 = forms.CharField(label='12. Otras compras - Other purchases', max_length=100)
    expenses_on_other_purchases_2 = forms.CharField(label='12. Otras compras - Other purchases', max_length=100)
    expenses_licenses_1 = forms.CharField(label='13. Licencias - Licenses', max_length=100)
    expenses_licenses_2 = forms.CharField(label='13. Licencias - Licenses', max_length=100)
    expenses_other_operating_1 = forms.CharField(label='14. Otros gastos - Other expenses', max_length=100)
    expenses_other_operating_2 = forms.CharField(label='14. Otros gastos - Other expenses', max_length=100)
    net_profit_loss_1 = forms.CharField(label='15. Ganancia neta (1-14) - Net profit (1-14)', max_length=100)
    net_profit_loss_2 = forms.CharField(label='15. Ganancia neta (1-14) - Net profit (1-14)', max_length=100)
    net_profit_loss_income_tax_1 = forms.CharField(label='16. Ganancia neta después de contribución sobre ingresos - Net profit after income tax', max_length=100)
    net_profit_loss_income_tax_2 = forms.CharField(label='16. Ganancia neta después de contribución sobre ingresos - Net profit after income tax', max_length=100)
    net_profit_after_tax_1 = forms.CharField(label='17. Ganancia neta después de contribución sobre ingresos - Net profit after income tax', max_length=100)
    net_profit_after_tax_2 = forms.CharField(label='17. Ganancia neta después de contribución sobre ingresos - Net profit after income tax', max_length=100)
    sales_and_use_withheld_1 = forms.CharField(label='18. Impuesto sobre ventas y uso retenido - Sales and use tax withheld', max_length=100)
    sales_and_use_withheld_2 = forms.CharField(label='18. Impuesto sobre ventas y uso retenido - Sales and use tax withheld', max_length=100)
    name = forms.CharField(label='Name of person filling the questionnaire', max_length=100)
    rank = forms.CharField(label='Rank', max_length=100)
...
class IP_610(forms.Form):
    ...
    incomes_services_rendered_1 = forms.CharField(label='1. Ingresos por servicios - Services rendered', max_length=100)
    incomes_services_rendered_2 = forms.CharField(label='1. Ingresos por servicios - Services rendered', max_length=100)
    incomes_unrestricted_A_1 = forms.CharField(label='a. Sin asignar - Unrestricted', max_length=100)
    incomes_unrestricted_A_2 = forms.CharField(label='a. Sin asignar - Unrestricted', max_length=100)
    incomes_restricted_A_1 = forms.CharField(label='b. Restricto - Restricted', max_length=100)
    incomes_restricted_A_2 = forms.CharField(label='b. Restricto - Restricted', max_length=100)
    ...
    incomes_rents_1 = forms.CharField(label='3. Renta de terreno y edificio - Rent of land and building', max_length=100)
    incomes_rents_2 = forms.CharField(label='3. Renta de terreno y edificio - Rent of land and building', max_length=100)
    incomes_interests_1 = forms.CharField(label='4. Intereses - Interests', max_length=100)
    incomes_interests_2 = forms.CharField(label='4. Intereses - Interests', max_length=100)
    incomes_capital_1 = forms.CharField(label='5. Ganancia o pérdida de capital - Capital gain or loss', max_length=100)
    incomes_capital_2 = forms.CharField(label='5. Ganancia o pérdida de capital - Capital gain or loss', max_length=100)
    incomes_total_1 = forms.CharField(label='6. Total de ingresos - Total incomes', max_length=100)
    incomes_total_2 = forms.CharField(label='6. Total de ingresos - Total incomes', max_length=100)
    
    expenses_salaries_1 = forms.CharField(label='1. Salarios, jornales, bono de Navidad y comisiones - Salaries, wages, Christmas bonus, <br>&emsp;and commissions', max_length=100)
    expenses_salaries_2 = forms.CharField(label='1. Salarios, jornales, bono de Navidad y comisiones - Salaries, wages, Christmas bonus, <br>&emsp;and commissions', max_length=100)
    expenses_interests_1 = forms.CharField(label='2. Intereses - Interests', max_length=100)
    expenses_interests_2 = forms.CharField(label='2. Intereses - Interests', max_length=100)
    expenses_rents_1 = forms.CharField(label='3. Renta de terreno y edificio - Rent of land and building', max_length=100)
    expenses_rents_2 = forms.CharField(label='3. Renta de terreno y edificio - Rent of land and building', max_length=100)
    expenses_depreciation_1 = forms.CharField(label='4. Depreciación - Depreciation', max_length=100)
    expenses_depreciation_2 = forms.CharField(label='4. Depreciación - Depreciation', max_length=100)
    expenses_debts_1 = forms.CharField(label='5.  Rentas incobrables - Bad debts', max_length=100)
    expenses_debts_2 = forms.CharField(label='5.  Rentas incobrables - Bad debts', max_length=100)
    expenses_donations_1 = forms.CharField(label='6. Donaciones - Donations', max_length=100)
    expenses_donations_2 = forms.CharField(label='6. Donaciones - Donations', max_length=100)
    expenses_tax_1 = forms.CharField(label='7. Impuesto sobre ventas y uso - Sales and use tax', max_length=100)
    expenses_tax_2 = forms.CharField(label='7. Impuesto sobre ventas y uso - Sales and use tax', max_length=100)
    expenses_machinery_1 = forms.CharField(label='a. Por Compra de maquinaria y equipo - On purchases of machinery and equipment', max_length=100)
    expenses_machinery_2 = forms.CharField(label='a. Por Compra de maquinaria y equipo - On purchases of machinery and equipment', max_length=100)
    other_purchases_1 = forms.CharField(label='b. Por otras compras - On other purchases', max_length=100)
    other_purchases_2 = forms.CharField(label='b. Por otras compras - On other purchases', max_length=100)
    expenses_licenses_1 = forms.CharField(label='8. Licencias y patentes - Licenses and patents', max_length=100)
    expenses_licenses_2 = forms.CharField(label='8. Licencias y patentes - Licenses and patents', max_length=100)
    expenses_other_1 = forms.CharField(label='9. Otros gastos de operación - Other operating expenses', max_length=100)
    expenses_other_2 = forms.CharField(label='9. Otros gastos de operación - Other operating expenses', max_length=100)
    net_profit_1 = forms.CharField(label='C. Ganancia o pérdida neta ( + ó - ) - Net profit or loss', max_length=100)
    net_profit_2 = forms.CharField(label='C. Ganancia o pérdida neta ( + ó - ) - Net profit or loss', max_length=100)
    income_tax_1 = forms.CharField(label='1. Contribución sobre ingresos - Income tax', max_length=100)
    income_tax_2 = forms.CharField(label='1. Contribución sobre ingresos - Income tax', max_length=100)
    profit_after_tax_1 = forms.CharField(label='2. Ganancia después de contribución sobre ingresos - Profit after income tax', max_length=100)
    profit_after_tax_2 = forms.CharField(label='2. Ganancia después de contribución sobre ingresos - Profit after income tax', max_length=100)
    ...
    signature = forms.CharField(label='Firma del contribuyente o representante legal / Signature of taxpayer or legal representative', max_length=100)
...
class IP_710(forms.Form):
    ...
    closing_date = forms.DateField(label='Fecha de cierre de sus libros / Your accounting period closing date', widget=forms.SelectDateWidget)
    start_year = forms.CharField(label='Año de inicio de operaciones / Year of start of operations', max_length=100)
    end_year = forms.CharField(label='Año de cierre de operaciones / Year of end of operations', max_length
                                 =100)
    incomes_service_1 = forms.CharField(label='1. Ingresos por servicios - Incomes from services', max_length=100)
    incomes_service_2 = forms.CharField(label='1. Ingresos por servicios - Incomes from services', max_length=100)
    incomes_from_persons_1 = forms.CharField(label='2. Ingresos de personas - Incomes from persons', max_length=100)
    incomes_from_persons_2 = forms.CharField(label='2. Ingresos de personas - Incomes from persons', max_length=100)
    incomes_from_industries_1 = forms.CharField(label='3. Ingresos de industrias - Incomes from industries', max_length=100)
    incomes_from_industries_2 = forms.CharField(label='3. Ingresos de industrias - Incomes from industries', max_length=100)
    incomes_from_sales_1 = forms.CharField(label='4. Ingresos por ventas - Incomes from sales', max_length=100)
    incomes_from_sales_2 = forms.CharField(label='4. Ingresos por ventas - Incomes from sales', max_length=100)
    income_rent_machinery_1 = forms.CharField(label='5. Ingresos por renta de maquinaria - Incomes from rent of machinery', max_length=100)
    income_rent_machinery_2 = forms.CharField(label='5. Ingresos por renta de maquinaria - Incomes from rent of machinery', max_length=100)
    income_rent_land_1 = forms.CharField(label='6. Ingresos por renta de terreno - Incomes from rent of land', max_length=100)
    income_rent_land_2 = forms.CharField(label='6. Ingresos por renta de terreno - Incomes from rent of land', max_length=100)
    income_interests_1 = forms.CharField(label='7. Ingresos por intereses - Incomes from interests', max_length=100)
    income_interests_2 = forms.CharField(label='7. Ingresos por intereses - Incomes from interests', max_length=100)
    income_capital_gain_or_loss_1 = forms.CharField(label='8. Ganancia o pérdida de capital - Capital gain or loss', max_length=100)
    income_capital_gain_or_loss_2 = forms.CharField(label='8. Ganancia o pérdida de capital - Capital gain or loss', max_length=100)
    income_other_operating_1 = forms.CharField(label='9. Otros ingresos operacionales - Other operating income', max_length=100)
    income_other_operating_2 = forms.CharField(label='9. Otros ingresos operacionales - Other operating income', max_length=100)
    expenses_salaries_1 = forms.CharField(label='1. Salarios - Salaries', max_length=100)
    expenses_salaries_2 = forms.CharField(label='1. Salarios - Salaries', max_length=100)
    expenses_interests_1 = forms.CharField(label='2. Intereses - Interests', max_length=100)
    expenses_interests_2 = forms.CharField(label='2. Intereses - Interests', max_length=100)
    expenses_rent_land_1 = forms.CharField(label='3. Renta de terreno - Rent of land', max_length=100)
    expenses_rent_land_2 = forms.CharField(label='3. Renta de terreno - Rent of land', max_length=100)
    expenses_depreciation_1 = forms.CharField(label='4. Depreciación - Depreciation', max_length=100)
    expenses_depreciation_2 = forms.CharField(label='4. Depreciación - Depreciation', max_length=100)
    expenses_bad_debts_1 = forms.CharField(label='5. Malos créditos - Bad debts', max_length=100)
    expenses_bad_debts_2 = forms.CharField(label='5. Malos créditos - Bad debts', max_length=100)
    expenses_donations_1 = forms.CharField(label='6. Donaciones - Donations', max_length=100)
    expenses_donations_2 = forms.CharField(label='6. Donaciones - Donations', max_length=100)
    expenses_other_operating_1 = forms.CharField(label='7. Otros gastos operacionales - Other operating expenses', max_length=100)
    expenses_other_operating_2 = forms.CharField(label='7. Otros gastos operacionales - Other operating expenses', max_length=100)
    expenses_sales_and_use_1 = forms.CharField(label='8. Impuesto sobre ventas y uso - Sales and use tax', max_length=100)
    expenses_sales_and_use_2 = forms.CharField(label='8. Impuesto sobre ventas y uso - Sales and use tax', max_length=100)
    expenses_purchases_machinery_1 = forms.CharField(label='9. Compra de maquinaria - Purchase of machinery', max_length=100)
    expenses_purchases_machinery_2 = forms.CharField(label='9. Compra de maquinaria - Purchase of machinery', max_length=100)
    expenses_other_purchases_1 = forms.CharField(label='10. Otras compras - Other purchases', max_length=100)
    expenses_other_purchases_2 = forms.CharField(label='10. Otras compras - Other purchases', max_length=100)
    expenses_licenses_1 = forms.CharField(label='11. Licencias - Licenses', max_length=100)
    expenses_licenses_2 = forms.CharField(label='11. Licencias - Licenses', max_length=100)
    profit_incomes_tax_1 = forms.CharField(label='12. Ganancia después de contribución sobre ingresos - Profit after income tax', max_length=100)
    profit_incomes_tax_2 = forms.CharField(label='12. Ganancia después de contribución sobre ingresos - Profit after income tax', max_length=100)
    profit_after_income_tax_1 = forms.CharField(label='13. Ganancia después de contribución sobre ingresos - Profit after income tax', max_length=100)
    profit_after_income_tax_2 = forms.CharField(label='13. Ganancia después de contribución sobre ingresos - Profit after income tax', max_length=100)
    sales_tax_withheld_1 = forms.CharField(label='14. Impuesto sobre ventas y uso retenido - Sales tax withheld', max_length=100)
...
class IP_540P(forms.Form):
    ...
    incomes_from_persons_1 = forms.CharField(label='1. Ingresos de personas - Incomes from persons', max_length=100)
    incomes_from_persons_2 = forms.CharField(label='1. Ingresos de personas - Incomes from persons', max_length=100)
    incomes_from_industries_and_businesses_1 = forms.CharField(label='2. Ingresos de industrias y negocios - Incomes from industries and businesses', max_length=100)
    incomes_from_industries_and_businesses_2 = forms.CharField(label='2. Ingresos de industrias y negocios - Incomes from industries and businesses', max_length=100)
    incomes_commissions_received_1 = forms.CharField(label='3. Comisiones recibidas - Commissions received', max_length=100)
    incomes_commissions_received_2 = forms.CharField(label='3. Comisiones recibidas - Commissions received', max_length=100)
    incomes_from_air_fare_1 = forms.CharField(label='4. Ingresos de pasajes aéreos - Incomes from air fare', max_length=100)
    incomes_from_air_fare_2 = forms.CharField(label='4. Ingresos de pasajes aéreos - Incomes from air fare', max_length=100)
    incomes_from_maritime_1 = forms.CharField(label='5. Ingresos de pasajes marítimos - Incomes from maritime', max_length=100)
    incomes_from_maritime_2 = forms.CharField(label='5. Ingresos de pasajes marítimos - Incomes from maritime', max_length=100)
    incomes_rent_1 = forms.CharField(label='6. Ingresos de renta - Incomes from rent', max_length=100)
    incomes_rent_2 = forms.CharField(label='6. Ingresos de renta - Incomes from rent', max_length=100)
    incomes_interests_1 = forms.CharField(label='7. Ingresos de intereses - Incomes from interests', max_length=100)
    incomes_interests_2 = forms.CharField(label='7. Ingresos de intereses - Incomes from interests', max_length=100)
    incomes_capital_gain_loss_1 = forms.CharField(label='8. Ganancia o pérdida de capital - Capital gain or loss', max_length=100)
    incomes_capital_gain_loss_2 = forms.CharField(label='8. Ganancia o pérdida de capital - Capital gain or loss', max_length=100)
    incomes_other_operating_1 = forms.CharField(label='9. Otros ingresos operacionales - Other operating income', max_length=100)
    incomes_other_operating_2 = forms.CharField(label='9. Otros ingresos operacionales - Other operating income', max_length=100)
    total_incomes_1 = forms.CharField(label='10. Total de ingresos - Total incomes', max_length=100)
    total_incomes_2 = forms.CharField(label='10. Total de ingresos - Total incomes', max_length=100)
    expenses_salaries_wages_bonus_1 = forms.CharField(label='1. Salarios, jornales, bono de Navidad y comisiones - Salaries, wages, Christmas bonus, <br>&emsp;and commissions', max_length=100)
    expenses_salaries_wages_bonus_2 = forms.CharField(label='1. Salarios, jornales, bono de Navidad y comisiones - Salaries, wages, Christmas bonus, <br>&emsp;and commissions', max_length=100)
    expenses_interests_1 = forms.CharField(label='2. Intereses - Interests', max_length=100)
    expenses_interests_2 = forms.CharField(label='2. Intereses - Interests', max_length=100)
    expenses_rent_1 = forms.CharField(label='3. Renta de terreno y edificio - Rent of land and building', max_length=100)
    expenses_rent_2 = forms.CharField(label='3. Renta de terreno y edificio - Rent of land and building', max_length=100)
    expenses_depreciation_1 = forms.CharField(label='4. Depreciación - Depreciation', max_length=100)
    expenses_depreciation_2 = forms.CharField(label='4. Depreciación - Depreciation', max_length=100)
    expenses_donations_1 = forms.CharField(label='5. Donaciones - Donations', max_length=100)
    expenses_donations_2 = forms.CharField(label='5. Donaciones - Donations', max_length=100)
    expenses_sales_taxes_1 = forms.CharField(label='6. Impuesto sobre ventas y uso - Sales and use tax', max_length=100)
    expenses_sales_taxes_2 = forms.CharField(label='6. Impuesto sobre ventas y uso - Sales and use tax', max_length=100)
    expenses_purchases_machinery_1 = forms.CharField(label='a. Por Compra de maquinaria y equipo - On purchases of machinery and equipment', max_length=100)
    expenses_purchases_machinery_2 = forms.CharField(label='a. Por Compra de maquinaria y equipo - On purchases of machinery and equipment', max_length=100)
    expenses_other_purchases_1 = forms.CharField(label='b. Por otras compras - On other purchases', max_length=100)
    expenses_other_purchases_2 = forms.CharField(label='b. Por otras compras - On other purchases', max_length=100)
    expenses_licenses_1 = forms.CharField(label='7. Licencias y patentes - Licenses and patents', max_length=100)
    expenses_licenses_2 = forms.CharField(label='7. Licencias y patentes - Licenses and patents', max_length=100)
    expenses_other_operating_1 = forms.CharField(label='8. Otros gastos de operación - Other operating expenses', max_length=100)
    expenses_other_operating_2 = forms.CharField(label='8. Otros gastos de operación - Other operating expenses', max_length=100)
    total_expenses_1 = forms.CharField(label='9. Total de gastos - Total expenses', max_length=100)
    total_expenses_2 = forms.CharField(label='9. Total de gastos - Total expenses', max_length=100)
    net_profit_1 = forms.CharField(label='C. Ganancia o pérdida neta ( + ó - ) - Net profit or loss', max_length=100)
    net_profit_2 = forms.CharField(label='C. Ganancia o pérdida neta ( + ó - ) - Net profit or loss', max_length=100)
    profit_income_tax_1 = forms.CharField(label='1. Contribución sobre ingresos - Income tax', max_length=100)
    profit_income_tax_2 = forms.CharField(label='1. Contribución sobre ingresos - Income tax', max_length=100)
    profit_after_income_tax_1 = forms.CharField(label='2. Ganancia después de contribución sobre ingresos - Profit after income tax', max_length=100)
    profit_after_income_tax_2 = forms.CharField(label='2. Ganancia después de contribución sobre ingresos - Profit after income tax', max_length=100)
    sales_tax_withheld_1 = forms.CharField(label='D. Impuesto sobre ventas y uso retenido - Sales and use tax Withheld', max_length=100)
    sales_tax_withheld_2 = forms.CharField(label='D. Impuesto sobre ventas y uso retenido - Sales and use tax Withheld', max_length=100)
...
class IP_540S(forms.Form):
    ...
    start_year = forms.CharField(label='Año de inicio de operaciones / Year of start of operations', max_length=100)
    end_year = forms.CharField(label='Año de cierre de operaciones / Year of end of operations', max_length=100)
    incomes_from_persons_1 = forms.CharField(label='incomes from persons 1', max_length=100)
    incomes_from_persons_2 = forms.CharField(label='incomes from persons 2', max_length=100)
    incomes_from_industries_and_businesses_1 = forms.CharField(label='incomes from industries and businesses 1', max_length=100)
    incomes_from_industries_and_businesses_2 = forms.CharField(label='incomes from industries and businesses 2', max_length=100)
    expenses_newspapers_1 = forms.CharField(label='expenses newspapers 1', max_length=100)
    expenses_newspapers_2 = forms.CharField(label='expenses newspapers 2', max_length=100)
    ...
    income_total_income_1 = forms.CharField(label='income total income 1', max_length=100)
    income_total_income_2 = forms.CharField(label='income total income 2', max_length=100)
    income_total_expenses_1 = forms.CharField(label='income total expenses 1', max_length=100)
    income_total_expenses_2 = forms.CharField(label='income total expenses 2', max_length=100)
    expenses_salaries_wages_bonus_1 = forms.CharField(label='expenses salaries wages bonus 1', max_length=100)
    expenses_salaries_wages_bonus_2 = forms.CharField(label='expenses salaries wages bonus 2', max_length=100)
    ...
    expenses_depreciation_1 = forms.CharField(label='expenses depreciation 1', max_length=100)
    expenses_depreciation_2 = forms.CharField(label='expenses depreciation 2', max_length=100)
    expenses_other_taxes_1 = forms.CharField(label='expenses other taxes 1', max_length=100)
    expenses_other_taxes_2 = forms.CharField(label='expenses other taxes 2', max_length=100)
    ...
    expenses_sales_taxes_1 = forms.CharField(label='expenses sales taxes 1', max_length=100)
    expenses_sales_taxes_2 = forms.CharField(label='expenses sales taxes 2', max_length=100)
    expenses_purchases_machinery_1 = forms.CharField(label='expenses purchases machinery 1', max_length=100)
    expenses_purchases_machinery_2 = forms.CharField(label='expenses purchases machinery 2', max_length=100)
    expenses_other_purchases_1 = forms.CharField(label='expenses other purchases 1', max_length=100)
    expenses_other_purchases_2 = forms.CharField(label='expenses other purchases 2', max_length=100)
    expenses_licenses_1 = forms.CharField(label='expenses licenses 1', max_length=100)
    expenses_licenses_2 = forms.CharField(label='expenses licenses 2', max_length=100)
    expenses_other_operation_1 = forms.CharField(label='expenses other operation 1', max_length=100)
    expenses_other_operation_2 = forms.CharField(label='expenses other operation 2', max_length=100)
    ...
    profit_after_income_tax_1 = forms.CharField(label='profit after income tax 1', max_length=100)
    profit_after_income_tax_2 = forms.CharField(label='profit after income tax 2', max_length=100)
...
class IP_540a(forms.Form):
    ...
    billings_1 = forms.CharField(label='A. Facturación o ventas  - Billing or sales', max_length=100)
    billings_2 = forms.CharField(label='A. Facturación o ventas  - Billing or sales', max_length=100)
    incomes_from_persons_1 = forms.CharField(label='1. De personas - From persons', max_length=100)
    incomes_from_persons_2 = forms.CharField(label='1. De personas - From persons', max_length=100)
    incomes_from_industries_and_businesses_1 = forms.CharField(label='2. De industrias y negocios - From industries and businesses', max_length=100)
    incomes_from_industries_and_businesses_2 = forms.CharField(label='2. De industrias y negocios - From industries and businesses', max_length=100)
    
    billing_expenses_1 = forms.CharField(label='B. Gastos de facturación - Billing expenses', max_length=100)
    billing_expenses_2 = forms.CharField(label='B. Gastos de facturación - Billing expenses', max_length=100)
    expenses_newspapers_1 = forms.CharField(label='1. Periódicos - Newspapers', max_length=100)
    expenses_newspapers_2 = forms.CharField(label='1. Periódicos - Newspapers', max_length=100)
    expenses_radio_television_1 = forms.CharField(label='2. Radio y televisión - Radio and television', max_length=100)
    expenses_radio_television_2 = forms.CharField(label='2. Radio y televisión - Radio and television', max_length=100)
    ...
    gross_profit_1 = forms.CharField(label='C. Ganancia bruta (A-B) - Gross profit (A-B)', max_length=100)
    gross_profit_2 = forms.CharField(label='C. Ganancia bruta (A-B) - Gross profit (A-B)', max_length=100)
    
    other_incomes_1 = forms.CharField(label='D. Otros ingresos - Other incomes', max_length=100)
    other_incomes_2 = forms.CharField(label='D. Otros ingresos - Other incomes', max_length=100)
    other_interests_1 = forms.CharField(label='1. Intereses - Interests', max_length=100)
    other_interests_2 = forms.CharField(label='1. Intereses - Interests', max_length=100)
    rent_of_land_1 = forms.CharField(label='2. Renta de terreno y edificio - Rent of land and building', max_length=100)
    rent_of_land_2 = forms.CharField(label='2. Renta de terreno y edificio - Rent of land and building', max_length=100)
    capital_1 = forms.CharField(label='3. Ganancia de capital - Capital gain', max_length=100)
    capital_2 = forms.CharField(label='3. Ganancia de capital - Capital gain', max_length=100)
    others_1 = forms.CharField(label='4. Otros - Others', max_length=100)
    others_2 = forms.CharField(label='4. Otros - Others', max_length=100)
    
    total_incomes_1 = forms.CharField(label='E. Total de ingresos (C+D) - Total incomes (C+D)', max_length=100)
    total_incomes_2 = forms.CharField(label='E. Total de ingresos (C+D) - Total incomes (C+D)', max_length=100)
    
    total_expenses_1 = forms.CharField(label='F. Total de gastos - Total expenses', max_length=100)
    total_expenses_2 = forms.CharField(label='F. Total de gastos - Total expenses', max_length=100)
    expenses_salaries_bonus_1 = forms.CharField(label='1. Salario, jornales, bono de Navidad y comisiones - Salaries, wages, Christmas bonus and comissions', max_length=100)
    expenses_salaries_bonus_2 = forms.CharField(label='1. Salario, jornales, bono de Navidad y comisiones - Salaries, wages, Christmas bonus and comissions', max_length=100)
    expenses_interests_1 = forms.CharField(label='2. Intereses - Interests', max_length=100)
    expenses_interests_2 = forms.CharField(label='2. Intereses - Interests', max_length=100)
    expenses_rent_1 = forms.CharField(label='3. Renta de terreno y edificio - Rent of land and building', max_length=100)
    expenses_rent_2 = forms.CharField(label='3. Renta de terreno y edificio - Rent of land and building', max_length=100)
    expenses_depreciation_1 = forms.CharField(label='4. Depreciación - Depreciation', max_length=100)
    expenses_depreciation_2 = forms.CharField(label='4. Depreciación - Depreciation', max_length=100)
    expenses_other_donations_1 = forms.CharField(label='5. Otras contribuciones - Other taxes', max_length=100)
    expenses_other_donations_2 = forms.CharField(label='5. Otras contribuciones - Other taxes', max_length=100)
    expenses_donations_1 = forms.CharField(label='6. Donaciones - Donations', max_length=100)
    expenses_donations_2 = forms.CharField(label='6. Donaciones - Donations', max_length=100)
    expenses_sales_taxes_1 = forms.CharField(label='7. Impuesto sobre ventas y uso - Sales and use tax', max_length=100)
    expenses_sales_taxes_2 = forms.CharField(label='7. Impuesto sobre ventas y uso - Sales and use tax', max_length=100)
    expenses_purchases_machinery_1 = forms.CharField(label='a. Por compra de maquinaria y equipo - On purchases of machinery and equipment', max_length=100)
    expenses_purchases_machinery_2 = forms.CharField(label='a. Por compra de maquinaria y equipo - On purchases of machinery and equipment', max_length=100)
    expenses_other_purchases_1 = forms.CharField(label='b. Otras compras - Other purchases', max_length=100)
    expenses_other_purchases_2 = forms.CharField(label='b. Otras compras - Other purchases', max_length=100)
    expenses_licenses_1 = forms.CharField(label='8. Licencias y patentes - Licenses and patents', max_length=100)
    expenses_licenses_2 = forms.CharField(label='8. Licencias y patentes - Licenses and patents', max_length=100)
    expenses_other_operationg_1 = forms.CharField(label='9. Otros gastos operacionales - Other operating expenses', max_length=100)
    expenses_other_operationg_2 = forms.CharField(label='9. Otros gastos operacionales - Other operating expenses', max_length=100)
    
    net_profit_1 = forms.CharField(label='G. Ganancia o pérdida neta (+ ó -) - Net profit or loss (+ or -)', max_length=100)
    net_profit_2 = forms.CharField(label='G. Ganancia o pérdida neta (+ ó -) - Net profit or loss (+ or -)', max_length=100)
    profit_income_tax_1 = forms.CharField(label='1. Contribución sobre ingresos - Income tax', max_length=100)
    profit_income_tax_2 = forms.CharField(label='1. Contribución sobre ingresos - Income tax', max_length=100)
    profit_after_income_tax_1 = forms.CharField(label='2. Ganancia después de contribución sobre ingresos - Profit after income tax', max_length=100)
    profit_after_income_tax_2 = forms.CharField(label='2. Ganancia después de contribución sobre ingresos - Profit after income tax', max_length=100)
    
    sales_tax_withheld_1 = forms.CharField(label='H. Impuesto sobre ventas y uso retenido - Sales tax withheld', max_length=100)
    sales_tax_withheld_2 = forms.CharField(label='H. Impuesto sobre ventas y uso retenido - Sales tax withheld, max_length=100')
...
class IP_540v(forms.Form):
    ...
    incomes_services_rendered_1 = forms.CharField(label='1. Ingresos por servicios prestados - Incomes from services rendered', max_length=100)
    incomes_services_rendered_2 = forms.CharField(label='1. Ingresos por servicios prestados - Incomes from services rendered', max_length=100)
    incomes_to_business_1 = forms.CharField(label='2. Ingresos a negocios - Incomes to business', max_length=100)
    incomes_to_business_2 = forms.CharField(label='2. Ingresos a negocios - Incomes to business', max_length=100)
    incomes_to_personal_pets_1 = forms.CharField(label='3. Ingresos a mascotas personales - Incomes to personal pets', max_length=100)
    incomes_to_personal_pets_2 = forms.CharField(label='3. Ingresos a mascotas personales - Incomes to personal pets', max_length=100)
    incomes_sale_merchandise_1 = forms.CharField(label='4. Ingresos por venta de mercancía - Incomes sale merchandise', max_length=100)
    incomes_sale_merchandise_2 = forms.CharField(label='4. Ingresos por venta de mercancía - Incomes sale merchandise', max_length=100)
    incomes_rent_of_land_and_building_1 = forms.CharField(label='5. Ingresos por renta de terreno y edificio - Incomes rent of land and building', max_length=100)
    incomes_rent_of_land_and_building_2 = forms.CharField(label='5. Ingresos por renta de terreno y edificio - Incomes rent of land and building', max_length=100)
    incomes_interests_1 = forms.CharField(label='6. Ingresos por intereses - Incomes interests', max_length=100)
    incomes_interests_2 = forms.CharField(label='6. Ingresos por intereses - Incomes interests', max_length=100)
    incomes_capital_gain_or_loss_1 = forms.CharField(label='7. Ganancia o pérdida de capital - Capital gain or loss', max_length=100)
    incomes_capital_gain_or_loss_2 = forms.CharField(label='7. Ganancia o pérdida de capital - Capital gain or loss', max_length=100)
    incomes_other_operating_income_1 = forms.CharField(label='8. Otros ingresos operacionales - Other operating income', max_length=100)
    incomes_other_operating_income_2 = forms.CharField(label='8. Otros ingresos operacionales - Other operating income', max_length=100)
    incomes_total_1 = forms.CharField(label='9. Total de ingresos - Total incomes', max_length=100)
    incomes_total_2 = forms.CharField(label='9. Total de ingresos - Total incomes', max_length=100)
    total_expenses_1 = forms.CharField(label='10. Total de gastos - Total expenses', max_length=100)
    total_expenses_2 = forms.CharField(label='10. Total de gastos - Total expenses', max_length=100)
    expenses_salaries_wages_bonus_1 = forms.CharField(label='1. Salarios, jornales, bono de Navidad y comisiones - Salaries, wages, Christmas bonus, and commissions', max_length=100)
    expenses_salaries_wages_bonus_2 = forms.CharField(label='1. Salarios, jornales, bono de Navidad y comisiones - Salaries, wages, Christmas bonus, and commissions', max_length=100)
    expenses_interests_1 = forms.CharField(label='2. Intereses - Interests', max_length=100)
    expenses_interests_2 = forms.CharField(label='2. Intereses - Interests', max_length=100)
    expenses_rent_1 = forms.CharField(label='3. Renta de terreno y edificio - Rent of land and building', max_length=100)
    expenses_rent_2 = forms.CharField(label='3. Renta de terreno y edificio - Rent of land and building', max_length=100)
    ...
    expenses_sales_taxes_1 = forms.CharField(label='7. Impuesto sobre ventas y uso - Sales and use tax', max_length=100)
    expenses_sales_taxes_2 = forms.CharField(label='7. Impuesto sobre ventas y uso - Sales and use tax', max_length=100)
    expenses_purchases_machinery_1 = forms.CharField(label='8. Por compra de maquinaria y equipo - On purchases of machinery and equipment', max_length=100)
    expenses_purchases_machinery_2 = forms.CharField(label='8. Por compra de maquinaria y equipo - On purchases of machinery and equipment', max_length=100)
    expenses_other_purchases_1 = forms.CharField(label='9. Por otras compras - On other purchases', max_length=100)
    expenses_other_purchases_2 = forms.CharField(label='9. Por otras compras - On other purchases', max_length=100)
    expenses_licenses_1 = forms.CharField(label='10. Licencias y patentes - Licenses and patents', max_length=100)
    expenses_licenses_2 = forms.CharField(label='10. Licencias y patentes - Licenses and patents', max_length=100)
    expenses_other_operating_1 = forms.CharField(label='11. Otros gastos de operación - Other operating expenses', max_length=100)
    expenses_other_operating_2 = forms.CharField(label='11. Otros gastos de operación - Other operating expenses', max_length=100)
    expenses_total_expenses_1 = forms.CharField(label='12. Total de gastos - Total expenses', max_length=100)
    expenses_total_expenses_2 = forms.CharField(label='12. Total de gastos - Total expenses', max_length=100)
    net_profit_1 = forms.CharField(label='13. Ganancia o pérdida neta ( + ó - ) - Net profit or loss', max_length=100)
    net_profit_2 = forms.CharField(label='13. Ganancia o pérdida neta ( + ó - ) - Net profit or loss', max_length=100)
    profit_income_tax_1 = forms.CharField(label='1. Contribución sobre ingresos - Income tax', max_length=100)
    profit_income_tax_2 = forms.CharField(label='1. Contribución sobre ingresos - Income tax', max_length=100)
    profit_after_income_tax_1 = forms.CharField(label='2. Ganancia después de contribución sobre ingresos - Profit after income tax', max_length=100)
    profit_after_income_tax_2 = forms.CharField(label='2. Ganancia después de contribución sobre ingresos - Profit after income tax', max_length=100)
    sales_tax_withheld_1 = forms.CharField(label='14. Impuesto sobre ventas y uso retenido - Sales and use tax Withheld', max_length=100)
    sales_tax_withheld_2 = forms.CharField(label='14. Impuesto sobre ventas y uso retenido - Sales and use tax Withheld', max_length=100)
    name = forms.CharField(label='Name of person filling the questionnaire', max_length=100)
    rank = forms.CharField(label='Rank', max_length=100)

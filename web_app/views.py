...
def IP_540v(request):
    ...
    if request.method == "POST":
        ...
        incomes_sale_merchandise_1 = request.POST.get("incomes_sale_merchandise_1")
        incomes_sale_merchandise_2 = request.POST.get("incomes_sale_merchandise_2")
        incomes_rent_of_land_and_building_1 = request.POST.get("incomes_rent_of_land_and_building_1")
        incomes_rent_of_land_and_building_2 = request.POST.get("incomes_rent_of_land_and_building_2")
        incomes_interests_1 = request.POST.get("incomes_interests_1")
        incomes_interests_2 = request.POST.get("incomes_interests_2")
        ...
        with open(csv_file_path, mode="a", newline="") as file:
            ...
            if not file_exists:
                writer.writerow(
                    [
                        "company_name", "address", "email", "liaison_officer", "ssn", "tel", "fax", "legal_form", "cfc", 
                        "business_type", "business_function", "branches", "branches_yes", "closing_date", "start_year", 
                        "end_year", "incomes_services_rendered_1", "incomes_services_rendered_2", "incomes_to_business_1",
                        "incomes_to_business_2", "incomes_to_personal_pets_1", "incomes_to_personal_pets_2", 
                        "incomes_sale_merchandise_1", "incomes_sale_merchandise_2", "incomes_rent_of_land_and_building_1", 
                        "incomes_rent_of_land_and_building_2", "incomes_interests_1", "incomes_interests_2", 
                        "incomes_capital_gain_or_loss_1", "incomes_capital_gain_or_loss_2", 
                        "incomes_other_operating_income_1", "incomes_other_operating_income_2", 
                        "incomes_total_1", "incomes_total_2", "total_expenses_1", "total_expenses_2", 
                        "expenses_salaries_wages_bonus_1", "expenses_salaries_wages_bonus_2", "expenses_interests_1", 
                        ...
                        "expenses_purchases_machinery_2", "expenses_other_purchases_1", "expenses_other_purchases_2", 
                        "expenses_licenses_1", "expenses_licenses_2", "expenses_other_operating_1", "expenses_other_operating_2", 
                        "expenses_total_expenses_1", "expenses_total_expenses_2", "net_profit_1", "net_profit_2", 
            ...
            writer.writerow(
                [
                    company_name, address, email, liaison_officer, ssn, tel, fax, legal_form, cfc, business_type,
                    business_function, branches, branches_yes, closing_date, start_year, end_year, incomes_services_rendered_1,
                    incomes_services_rendered_2, incomes_to_business_1, incomes_to_business_2, incomes_to_personal_pets_1,
                    incomes_to_personal_pets_2, incomes_sale_merchandise_1, incomes_sale_merchandise_2, incomes_rent_of_land_and_building_1,
                    incomes_rent_of_land_and_building_2, incomes_interests_1, incomes_interests_2, incomes_capital_gain_or_loss_1,
                    incomes_capital_gain_or_loss_2, incomes_other_operating_income_1, incomes_other_operating_income_2, incomes_total_1,
                    incomes_total_2, total_expenses_1, total_expenses_2, expenses_salaries_wages_bonus_1, expenses_salaries_wages_bonus_2,
                    expenses_interests_1, expenses_interests_2, expenses_rent_1, expenses_rent_2, expenses_depreciation_1, expenses_depreciation_2,
                    expenses_bad_debts_1, expenses_bad_debts_2, expenses_donations_1, expenses_donations_2, expenses_sales_taxes_1,
                    expenses_sales_taxes_2, expenses_purchases_machinery_1, expenses_purchases_machinery_2, expenses_other_purchases_1,
                    expenses_other_purchases_2, expenses_licenses_1, expenses_licenses_2, expenses_other_operating_1, expenses_other_operating_2,
                    expenses_total_expenses_1, expenses_total_expenses_2, net_profit_1, net_profit_2, profit_income_tax_1,

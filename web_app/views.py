...
def macro(request):
    ...
    # x_title = "Periodo = Año Fiscal"

    # y_title = "Producto Bruto (Millones $)"
    ...
    y_axis_options = [
        "PRODUCTO BRUTO (MILLONES $)",
        "INGRESO NETO (MILLONES $)",
        "INGRESO PERSONAL (MILLONES $)",
        "INGRESO PERSONAL DISPONIBLE (MILLONES $)",
        "PRODUCTO BRUTO INTERNO (MILLONES $)",
        "INVERSION INTERNA BRUTA DE CAPITAL FIJO (MILLONES $)",
        "INGRESO PROMEDIO POR FAMILIA  (EN DOLARES)",
        "NUMERO PROMEDIO DE PERSONAS POR FAMILIA",
        "SUELDOS Y JORNALES (MILLONES $)",
        "INGRES NETO ORIGINADO EN EL TURISMO (MILLONES $)",
        "EMPLEO TOTAL (EN MILES $)",
        "PRODUCTIVIDAD[PBI CONSTANTE/EMPTOT (EN DOLARES)]",
        "INDICE PRECIO AL CONSUMIDOR (67=100)",
        "POBLACION (EN MILES)",
        "GASTO CONSUMO PERSONAL TOTAL (MILLONES$)",
        "GASTO CONSUMO ARTICULOS DURADEROS (MILLONES $)",
        "GASTO CONSUMO ARTICULOS NO DURADEROS (MILLONES $)",
        "GASTO CONSUMO SERVICIOS (MILLONES $)",
        "GASTO CONSUMO GOBIERNO TOTAL (MILLONES $)",
        "GASTO  CONSUMO GOB. CENTRAL(MILLONES $)",
        "GASTO CONSUMO GOB. MUNICIPIOS (MILLONES $)",
        "INVERSION INTERNA BRUTA ,TOTAL (MILLONES $)",
        "CAMBIO EN INVENTARIO",
        "CONSTRUCCION TOTAL (MILLONES $)",
        "CONSTRUCCION EMPRESAS PRIVADAS (MILLONES $)",
        "CONTRUCCION EMPRESAS PUBLICAS (MILLONES $)",
        "CONSTRUCCION GOBIERNO (MILLONES $)",
        "CONSTRUCCION GOB. CENTRAL (MILLONES$)",
        "CONSTRUCCION MUNICIPIOS (MILLONES $)",
        "MAQUINARIA EQUIPO (MILLONES $)",
        "MAQ. EMPRESAS PRIVADAS (MILLONES $)",
        "MAQ. EMPRESAS PUBLICAS (MILLONES$)",
        "MAQ. GOBIERNO (MILLONES $)",
        "MAQELA = MAQ. GOB CENTRAL (MILLONES $)",
        "MAQ. MUNICIPIOS (MILLONES $)",
        "VENTAS NETAS AL RESTO DEL MUNDO (MILLONES $)",
        "VENTAS TOTALES AL RESTO DEL MUNDO (MILLONES $)",
        "VENTAS GOB. FEDERAL (MILLONES $)",
        "VENTAS OTROS NO RESIDENTES (MILLONES $)",
        "COMPRAS RESTO DEL MUNDO TOTAL (MILLONES $)",
        "COMPRAS GOB. FEDERAL (MILLONES )",
        "COMPRAS OTROS NO RESIDENTS (MILLONES)",
        "INDICES DEFLACION PRODUCTO BRUTO (54=100)",
        "INDICES DEFLACION GASTO CONSUMO PERSONAL (54=100)",
        "INDICES DEFLACION ARTICULOS DURADERO (54=100)",
        "INDICES DEFLACION ARTICULOS NO DURADEROS (54=100)",
        "INDICES DEFLACION SERVICIOS (54=100)",
        "INDICES DEFLACION GASTO CONSUMO GOB. TOTAL (54=100)",
        "INDICES DEFLACION G.C.GOB. ELA (54=100)",
        "INDICES DEFLACION G.C.GOB MUNICIPIOS (54=100)",
        "INDICES DEFLACION INVER. INTERNA BRUTA,TOTAL (54=100)",
        "INDICES DEFL. INVER. INTERNA BRUTA CAPITAL FIJO (54=100)",
        "INDICES DEFLACION CONSTRUCCION (54=100)",
        "INDICES DEFLACION MAQ. Y EQUIPO (54=100)",
        "INDICES DEFLACION VENTAS NETAS (54=100)",
        "INDICES DEFLACION VENTAS RESTO DEL MUNDO (54=100)",
        "INDICES DEFLACION VENTAS GOB FEDERAL (54=100)",
        "INDICES DEFL. VENTAS OTROS NO RESIDENTES (54=100)",
        "INDICE DEFLA. COMPRAS AL RESTO DEL MUNDO (54=100)",
        "INDICE DEFLACION COMPRAS GOB FEDERAL (54=100)",
        "INDICE DEFLA. COMPRAS OTROS NO RESIDENTES (54=100)",
        "GASTO CONSUMO PERSONAL ALIMENTO (MILLONES $)",
        "G.C.P. ALCOHOLICAS Y TABACO (MILLONES $)",
        "G.C.P. ROPA",

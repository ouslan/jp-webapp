...
class DataProcessHistoricalSeries:
    ...
    def __init__(self, folder_path_1: str, folder_path_2: str, saving_path: str, debug: bool = False):
        ...
        self.df1.write_parquet(f"{self.saving_path}Series-Historicas-1950-2011_process.parquet")   

        self.df2 = self.process_data2(self.folder_path_2)
        self.df2.write_parquet(f"{self.saving_path}Series-Historicas-2001-2023_process.parquet")  

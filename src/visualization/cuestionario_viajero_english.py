...
def cuestionario_viajero_english(request):
  if request.method == "POST":
    ...
    priority_accommodation = request.POST.get("priority_accommodation")
    priority_food = request.POST.get("priority_food")
    priority_transportation = request.POST.get("priority_transportation")
    priority_activities = request.POST.get("priority_activities")
    priority_shopping = request.POST.get("priority_shopping")
    ...
    accommodation_2 = request.POST.get("accommodation_2")
    ...
    priority_accommodation_2 = request.POST.get("priority_accommodation_2")
    priority_select_2 = request.POST.get("priority_select_2")
    priority_transportation_2 = request.POST.get("priority_transportation_2")
    priority_activities_2 = request.POST.get("priority_activities_2")
    priority_shopping_2 = request.POST.get("priority_shopping_2")
    priority_other_2 = request.POST.get("priority_other_2")
    ...
    data = [
      ...
      pl.Series("priority_accommodation", [priority_accommodation], dtype=pl.Utf8),
      pl.Series("priority_food", [priority_food], dtype=pl.Utf8),
      pl.Series("priority_transportation", [priority_transportation], dtype=pl.Utf8),
      pl.Series("priority_activities", [priority_activities], dtype=pl.Utf8),
      pl.Series("priority_shopping", [priority_shopping], dtype=pl.Utf8),
      ...
      pl.Series("accommodation_2", [accommodation_2], dtype=pl.Utf8),
      ...
      pl.Series("priority_select_2", [priority_select_2], dtype=pl.Utf8),
      ...
      pl.Series("priority_other_2", [priority_other_2], dtype=pl.Utf8)

    ]

  return render(request, 'cuestionario_viajero_english.html')
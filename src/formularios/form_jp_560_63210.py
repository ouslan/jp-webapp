...
def JP_560_63210(request):
    if request.method == "POST":
        ...
        data = [
            ...
            pl.Series("disability_A_1", [float(disability_A_1)], dtype=pl.Float64),
            pl.Series("disability_A_2", [float(disability_A_2)], dtype=pl.Float64),
            pl.Series("cars_A_1", [float(cars_A_1)], dtype=pl.Float64),
            pl.Series("cars_A_2", [float(cars_A_2)], dtype=pl.Float64),
            ...
            pl.Series("disability_B_1", [float(disability_B_1)], dtype=pl.Float64),
            pl.Series("disability_B_2", [float(disability_B_2)], dtype=pl.Float64),
            pl.Series("cars_B_1", [float(cars_B_1)], dtype=pl.Float64),
            pl.Series("cars_B_2", [float(cars_B_2)], dtype=pl.Float64),
            pl.Series("other_B_1", [float(other_B_1)], dtype=pl.Float64),
            pl.Series("other_B_2", [float(other_B_2)], dtype=pl.Float64),
        ...
        DAO().insert_forms(df, "JP_560_63210", 23)

...
def IP_540P(request):
    if request.method == "POST":
        ...
        data = [
            ...
            pl.Series("incomes_commissions_received_1", [float(incomes_commissions_received_1)], dtype=pl.Float64),
            pl.Series("incomes_commissions_received_2", [float(incomes_commissions_received_2)], dtype=pl.Float64),
            pl.Series("incomes_from_air_fare_1", [float(incomes_from_air_fare_1)], dtype=pl.Float64),
            pl.Series("incomes_from_air_fare_2", [float(incomes_from_air_fare_2)], dtype=pl.Float64),
            pl.Series("incomes_from_maritime_1", [float(incomes_from_maritime_1)], dtype=pl.Float64),
            pl.Series("incomes_from_maritime_2", [float(incomes_from_maritime_2)], dtype=pl.Float64),
        ...
        DAO().insert_forms(df, "IP_540P", 20)

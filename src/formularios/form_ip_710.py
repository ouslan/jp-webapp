...
def IP_710(request):
    if request.method == "POST":
        ...
        data = [
            ...
            pl.Series("incomes_service_1", [float(incomes_service_1)], dtype=pl.Float64),
            pl.Series("incomes_service_2", [float(incomes_service_2)], dtype=pl.Float64),
            ...
            pl.Series("incomes_from_sales_1", [float(incomes_from_sales_1)], dtype=pl.Float64),
            pl.Series("incomes_from_sales_2", [float(incomes_from_sales_2)], dtype=pl.Float64),
            pl.Series("income_rent_machinery_1", [float(income_rent_machinery_1)], dtype=pl.Float64),
            pl.Series("income_rent_machinery_2", [float(income_rent_machinery_2)], dtype=pl.Float64),
            pl.Series("income_rent_land_1", [float(income_rent_land_1)], dtype=pl.Float64),
            pl.Series("income_rent_land_2", [float(income_rent_land_2)], dtype=pl.Float64),
            pl.Series("income_interests_1", [float(income_interests_1)], dtype=pl.Float64),
            pl.Series("income_interests_2", [float(income_interests_2)], dtype=pl.Float64),
            pl.Series("income_capital_gain_or_loss_1", [float(income_capital_gain_or_loss_1)], dtype=pl.Float64),
            pl.Series("income_capital_gain_or_loss_2", [float(income_capital_gain_or_loss_2)], dtype=pl.Float64),
            pl.Series("income_other_operating_1", [float(income_other_operating_1)], dtype=pl.Float64),
            pl.Series("income_other_operating_2", [float(income_other_operating_2)], dtype=pl.Float64),
            ...
            pl.Series("expenses_rent_land_1", [float(expenses_rent_land_1)], dtype=pl.Float64),
            pl.Series("expenses_rent_land_2", [float(expenses_rent_land_2)], dtype=pl.Float64),
            ...
            pl.Series("expenses_sales_and_use_1", [float(expenses_sales_and_use_1)], dtype=pl.Float64),
            pl.Series("expenses_sales_and_use_2", [float(expenses_sales_and_use_2)], dtype=pl.Float64),

...
def IP_540v(request):
    ...
    if request.method == "POST":
        ...
        data = [
            ...
            pl.Series("incomes_to_business_1", [float(incomes_to_business_1)], dtype=pl.Float64),
            pl.Series("incomes_to_business_2", [float(incomes_to_business_2)], dtype=pl.Float64),
            pl.Series("incomes_to_personal_pets_1", [float(incomes_to_personal_pets_1)], dtype=pl.Float64),
            pl.Series("incomes_to_personal_pets_2", [float(incomes_to_personal_pets_2)], dtype=pl.Float64),
            ...
            pl.Series("incomes_rent_of_land_and_building_1", [float(incomes_rent_of_land_and_building_1)], dtype=pl.Float64),
            pl.Series("incomes_rent_of_land_and_building_2", [float(incomes_rent_of_land_and_building_2)], dtype=pl.Float64),
            ...
            pl.Series("expenses_total_expenses_1", [float(expenses_total_expenses_1)], dtype=pl.Float64),
            pl.Series("expenses_total_expenses_2", [float(expenses_total_expenses_2)], dtype=pl.Float64),
        ...
        DAO().insert_forms(df, "IP_540v", 12)
